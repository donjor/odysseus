...
`/oauth/token`. (Wire mirrored from a working remote deployment; see
`.dump/references/hermes-openai-codex-implementation-spec.md`.)
...
# opencode, Hermes, codex itself). No codex CLI binary is required.
