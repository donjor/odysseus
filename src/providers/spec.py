...
`auth_type` is `"api_key"` for both PR1 builtins; `"oauth"` is reserved for the
ChatGPT-subscription / codex provider added in a later PR.
"""
...
class ProviderSpec:
    ...
    auth_type: str            # "api_key" | "oauth" (oauth reserved for PR2)
